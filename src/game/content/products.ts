...
export const SHELF_POOL: ShelfItem[] = [
  { name: 'Black Truffle Seed Crisps', price: 12, source: 'pool' },
  { name: 'Tamari & Nori Seed Crisps', price: 12, source: 'pool' },
  { name: 'Elly Amai Japanese Strawberry (single)', price: 19, source: 'pool' },
  { name: 'Pink Glow Sea Moss Gel', price: 44, source: 'pool' },
  { name: 'Blue Pearl Sea Moss Gel', price: 44, source: 'pool' },
  { name: 'Raw A2/A2 Whole Milk (half gal)', price: 22, source: 'pool' },
  { name: 'ARMRA Colostrum', price: 52, source: 'pool' },
  { name: 'Liposomal Glutathione', price: 100, source: 'pool' },
  { name: 'Liposomal Vitamin C', price: 76, source: 'pool' },
  { name: 'Organic Olivia Liver Juice', price: 38, source: 'pool' },
  { name: 'Sleep Formula', price: 74, source: 'pool' },
  { name: 'A2 Whey Protein', price: 68, source: 'pool' },
  { name: 'House-Made Granola', price: 18, source: 'pool' },
  { name: 'Chlorophyll Water', price: 5, source: 'pool' },
  { name: 'Fire Cider Immunity Shot', price: 7, source: 'pool' },
  { name: 'Mushroom Coffee Latte', price: 10, source: 'pool' },
  { name: 'Erewhon Hoodie', price: 170, source: 'pool' },
  { name: 'Erewhon Dad Hat', price: 70, source: 'pool' },
  { name: 'Coconut Cloud Smoothie Kit (makes 4)', price: 100, source: 'pool' },
  { name: 'Erewhon Candle', price: 70, source: 'pool' },
  { name: 'Tie-Dye Socks', price: 36, source: 'pool' },
  { name: 'Beach Towel', price: 100, source: 'pool' },
  { name: 'Pistachio Chocolate Toffee', price: 15, source: 'pool' },
  { name: 'Vegan Chocolate Chip Cookie', price: 5, source: 'pool' },
  { name: 'Avocado Toast', price: 16, source: 'pool' },
  { name: 'Kale Caesar (hot bar, per lb)', price: 18, source: 'pool' },
];
